    ...
    <div className="font-sans">
      <div className="container mx-auto py-12 px-6 max-w-3xl">
        ...
        <p className="text-lg mb-6">
          <strong>Mentora</strong> was born from a desire to go beyond traditional chatbots. While most bots only respond — Mentora listens, learns, and reflects your inner mind. Built with insights from psychology, NLP, cognitive science, neuropsychology, and design strategy, Mentora acts as a personal communication mirror.
        </p>
        <p className="text-lg mb-6">
